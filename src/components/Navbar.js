          ...
          <div tabIndex={0} className={`${scrolled ? 'text-black' : 'text-gray-100'}`}><NavLink to='/About'>About</NavLink></div>
            <div className='mt-4 -ml-[140px]'>
              <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow items-center rounded-box w-52 mt-2 bg-gray-600">
                <li className={`${scrolled ? 'text-black' : 'text-gray-100'} ${scrolled ? 'hover:text-white' : 'hover:text-gray-900'}`}><a>Directory of Grants</a></li>
                <li className={`${scrolled ? 'text-black' : 'text-gray-100'} ${scrolled ? 'hover:text-white' : 'hover:text-gray-900'}`}><a>Professional Chair</a></li>
              </ul>
          </div>
      </div>
      </li>
